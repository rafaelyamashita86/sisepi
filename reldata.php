                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    $pesquisa = mysqli_query($conn, "SELECT entrega.id,funcionarios.nome,DATE_FORMAT( data, '%d/%c/%Y %H:%i:%s' ) AS data,epi.descricao,entrega.quantidade FROM epi,entrega,funcionarios WHERE DATE(data) BETWEEN '$inicio' AND '$fim' AND epi.id= entrega.id_epi AND funcionarios.matricula=entrega.matricula_func");
